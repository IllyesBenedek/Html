...
def test_title():
    html = load_html()
    assert "<title>Költség</title>" in html, "❌ 3. feladat: A cím nem 'Költség'."
    print("✔️ 3. feladat rendben: cím 'Költség'.")
...
def test_h1():
    ...
    assert h1.text.strip() == "Költség", "❌ 6. feladat: A H1 cím nem 'Költség'."
    print("✔️ 6. feladat rendben: H1 = Költség.")